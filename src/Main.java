...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        manager.updateTask(new Task(task1.getNameTask(), task1.getDescription(), DONE, task1.getId()));
        manager.updateEpic((new Epic(epic2.getNameTask(), epic2.getDescription(), DONE, epic2.getId(),
