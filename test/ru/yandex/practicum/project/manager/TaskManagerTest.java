...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    void createEpicWithOneSubtask() throws IOException {
        ...
        ArrayList<Subtask> epicSubtasks1 = new ArrayList<Subtask>(List.of(new Subtask("nameTask",
    ...
    @Test
    void checkCrossSubtaskForAddTest() throws IOException { //тест на пересечение задач по времени
